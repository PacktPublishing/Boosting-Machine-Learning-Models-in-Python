...
Extremely Randomized Trees (Extra-Trees) with 100 trees.
"""
...
model = ExtraTreesClassifier(n_estimators=100, max_features='log2', random_state=seed)
...
print('\t\tSingle model accuracy\t\tExtra-Trees model accuracy')
